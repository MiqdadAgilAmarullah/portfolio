...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Portfolio Miqdad Agil Amarullah v.1">
    ...
    <div class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h2>I am very excited to start contribute to your project</h2>
                        <p>my experience from various types of work</p>
                        <a class="btn-solid-reg popup-with-move-anim" href="#details-lightbox-1">Look Experience</a>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="image-container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        ...
                        <li class="media">
                            <i class="fas fa-check"></i><div class="media-body">Operator Warehouse & Preparation at PT. NORTAKE INDONESIA</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-check"></i><div class="media-body">Intern Programmer at PT. Kalbe MORINAGA INDONESIA</div>
                        </li>
                    </ul>
                    <a class="btn-solid-reg mfp-close page-scroll" href="#contact">CONTACT ME</a> <a class="btn-outline-reg mfp-close as-button" href="#screenshots">BACK</a>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="image-container">
                            <div class="video-wrapper">
                                <a class="popup-youtube" href="https://www.youtube.com/watch?v=FN4bOJSMsmo" data-effect="fadeIn">
                                    <img class="img-fluid" src="images/calcu.png" alt="alternative">
                                    <span class="video-play-button">
                                        <span></span>
                                    </span>
                                </a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="image-container">
                            <div class="video-wrapper">
                                <a class="popup-youtube" href="https://www.youtube.com/watch?v=DtsBtYMbEAY" data-effect="fadeIn">
                                    <img class="img-fluid" src="images/arbangun.png" alt="alternative">
                                    <span class="video-play-button">
                                        <span></span>
                                    </span>
                                </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        <li class="address">Don't hesitate to give me a call</li>
